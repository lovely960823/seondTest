...
<div class="with:80%">
		...
		action="doTeacherEdit" method="post">
		<input type="hidden" name="id" value="${teacher.id}"/>
		<input type="hidden"  name="pwd" value="${teacher.pwd}">
			<div class="form-group">
				<label for="name" class="col-sm-2 control-label">教师姓名</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="name"
						id="name" placeholder="请输入姓名" value="${teacher.name}"/>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="num" value="${teacher.num}"   readonly="true"
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					<input type="text" class="form-control" name="pubdate" id="inputPubDate"
						placeholder="日期"  value="${teacher.pubdate}"/>
			    </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					autocomplete="off"	placeholder="电话" value="${teacher.phone}" />
			    </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					autocomplete="off"	placeholder="办公地点" value="${teacher.address}" />
			    </div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-sm-10">
					...
					autocomplete="off"	placeholder="邮箱" value="${teacher.email}" />
			    </div>
			</div>
