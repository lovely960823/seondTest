...
<div class="with:80%">
		<form:form class="form-horizontal" modelAttribute="student" id="formSubmit"
			action="doStudentAdd" method="post">
			...
			<div class="form-group">
				<label for="pubdate" class="col-sm-2 control-label">寝室编号</label>
				<div class="col-sm-10">
					<input type="text" class="form-control" name="address" id="address"
					autocomplete="off"	placeholder="寝室编号" />
			    </div>
			</div>
			...
			$.ajax({
				...
				success:function(data){
					if(data == 0){
						...
						alert("添加成功");
						window.location.href="toStudentAdd";
					}else{
